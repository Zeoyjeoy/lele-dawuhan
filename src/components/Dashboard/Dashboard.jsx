        ...
        <div className="flex w-full max-w-6xl items-center justify-center relative z-10">
          ...
          <div className="hidden lg:flex lg:w-1/2 items-center justify-center">
            <div className="relative">
              <img src="/assets/bg.svg" alt="Login Illustration" className="w-96 h-96 object-contain" />
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="flex w-full max-w-6xl items-center justify-center relative z-10">
        ...
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center">
          <div className="relative">
            <img src="/assets/bg.svg" alt="Register Illustration" className="w-96 h-96 object-contain" />
          </div>
        </div>
